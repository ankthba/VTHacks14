  ...
  return (
    <div className="no-print">
      <button
        ...
        className="rounded-lg border-2 border-[color:var(--accent)] px-4 py-2 font-semibold text-[color:var(--accent)] hover:bg-[color:var(--accent)] hover:text-white disabled:opacity-60"
      >
        {state === "loading"
          ? "Preparing audio..."
          : state === "playing"
