 ...
 *
 * These are real rendered anatomy - meshes a patient can turn with a finger -
 * embedded from Sketchfab under Creative Commons licences, chosen for being
 * clear rather than clinical-photographic. Nothing here is a specimen photo.
 *
 * The 3D model gives recognition ("that is my knee"); the marked line diagram
 * beside it gives precision ("and that is exactly the part"). The two are shown
 * together on the patient screen, and only the diagram goes to paper, because
 * an iframe does not print.
 *
...
export const MODELS: Record<DiagramId, Model3D> = {
  ...
  heart: { uid: "3f8072336ce94d18b3d0d055a1ece089", title: "Realistic Human Heart", author: "neshallads", license: "CC BY" },
  lung: { uid: "ce09f4099a68467880f46e61eb9a3531", title: "Realistic Human Lungs", author: "neshallads", license: "CC BY" },
